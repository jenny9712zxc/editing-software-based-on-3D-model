...
class loader:
    ...
    def draw(self):
        ...
        for tri in self.get_triangles():
            ...
            glVertex3d(tri.points[0].x,tri.points[0].y,tri.points[0].z)
            glVertex3d(tri.points[1].x,tri.points[1].y,tri.points[1].z)
            glVertex3d(tri.points[2].x,tri.points[2].y,tri.points[2].z)            
            #generate list
            v0=(tri.points[0].x,tri.points[0].y,tri.points[0].z)
            v1=(tri.points[1].x,tri.points[1].y,tri.points[1].z)
            v2=(tri.points[2].x,tri.points[2].y,tri.points[2].z)
            list_tmp=[]
            list_tmp.append(tuple(v0))
...
class draw_scene:
    def __init__(self,style=1):
        ...
        self.model1.load_stl(os.path.abspath('')+'/bunny.stl')
        self.init_shading()
